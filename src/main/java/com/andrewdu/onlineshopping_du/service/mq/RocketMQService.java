...
public class RocketMQService {
    ...
    public void sendFIFOMessage(String topic, String messageBody, long commodityId) {
        Message msg = new Message(topic, messageBody.getBytes());
        rocketMQTemplate.syncSendOrderly(topic, messageBody, String.valueOf(commodityId));
    }
